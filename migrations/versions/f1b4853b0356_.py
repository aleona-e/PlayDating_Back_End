...
Revision ID: f1b4853b0356
Revises: 
Create Date: 2022-07-06 13:37:41.696067
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['ubicacion_id'], ['lugar_evento.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
